...
function addTodo(todo) {
	...
	let newTodo = $(
		`<li class="task" id=${todo._id}>${todo.todo}<span id="deleteIcon"><i class="fas fa-trash-alt"></i></span></li>`
	);
...
function createTodo() {
	...
	$('#todoInput').val('');
	$('.list').append(
		$(`<li class="task">${todo}<span id="loadingContainer"> <span class="lazyloader"></span></span></li>`)
	);
